...
\restrict Gam9YHgh8NVgNjfq0zqFxqVGvz4Mfa6dh38x4rhHYL0acevftZ9baXkq1qcXabp
...
CREATE FUNCTION public.generate_ticket_code() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
begin
  ...
  new.ticket_code :=
    'TCK-' ||
    lpad(nextval('tickets_id_seq')::text, 6, '0');
...
--
-- Name: notify_admins_new_ticket(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.notify_admins_new_ticket() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
begin
  insert into public.notifications (user_id, title, message, is_read, ticket_id)
  select
    profiles.id,
    'Tiket Baru ' || coalesce(new.ticket_code, '#' || new.id::text),
    'Tiket baru masuk: ' || new.title,
    false,
    new.id
...
ALTER FUNCTION public.notify_admins_new_ticket() OWNER TO postgres;

--
-- Name: notify_admins_status_change_by_helpdesk(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.notify_admins_status_change_by_helpdesk() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
begin
  if new.status is distinct from old.status then
    ...
    if auth.uid() = new.assigned_to then
      ...
      select
        profiles.id,
        'Update Tiket ' || coalesce(new.ticket_code, '#' || new.id::text),
        'Helpdesk mengubah status tiket "' || new.title || '" menjadi ' || new.status,
        false,
        new.id
      from public.profiles
      where profiles.role = 'admin';
...
ALTER FUNCTION public.notify_admins_status_change_by_helpdesk() OWNER TO postgres;

--
-- Name: notify_helpdesk_assigned(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.notify_helpdesk_assigned() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
begin
  if new.assigned_to is distinct from old.assigned_to
    ...
    values (
      new.assigned_to,
      'Tiket Ditugaskan ' || coalesce(new.ticket_code, '#' || new.id::text),
      'Anda ditugaskan menangani tiket: ' || new.title,
      false,
      new.id
    );
...
ALTER FUNCTION public.notify_helpdesk_assigned() OWNER TO postgres;

--
-- Name: notify_ticket_status_change(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.notify_ticket_status_change() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
declare
...
begin
  if new.status is distinct from old.status then
    ...
    status_label := case new.status
      when 'assigned' then 'Tiket Anda telah ditugaskan ke helpdesk'
      when 'in_progress' then 'Tiket Anda sedang dikerjakan'
      when 'resolved' then 'Tiket Anda telah diselesaikan'
      when 'closed' then 'Tiket Anda telah ditutup'
      else 'Status tiket Anda berubah menjadi ' || new.status
    end;
...
ALTER FUNCTION public.notify_ticket_status_change() OWNER TO postgres;
...
ALTER TABLE public.ticket_attachments ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
--
-- Name: ticket_tracking; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.ticket_tracking OWNER TO postgres;

--
-- Name: ticket_tracking_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.ticket_tracking ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.ticket_tracking_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.tickets (
    ...
    CONSTRAINT tickets_status_check CHECK ((status = ANY (ARRAY['open'::text, 'assigned'::text, 'in_progress'::text, 'resolved'::text, 'closed'::text])))
);
...
--
-- Name: ticket_tracking ticket_tracking_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ticket_tracking
    ADD CONSTRAINT ticket_tracking_pkey PRIMARY KEY (id);
...
--
-- Name: tickets trg_notify_admins_new_ticket; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_notify_admins_new_ticket AFTER INSERT ON public.tickets FOR EACH ROW EXECUTE FUNCTION public.notify_admins_new_ticket();


--
-- Name: tickets trg_notify_admins_status_change; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_notify_admins_status_change AFTER UPDATE ON public.tickets FOR EACH ROW EXECUTE FUNCTION public.notify_admins_status_change_by_helpdesk();


--
-- Name: tickets trg_notify_helpdesk_assigned; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_notify_helpdesk_assigned AFTER UPDATE ON public.tickets FOR EACH ROW EXECUTE FUNCTION public.notify_helpdesk_assigned();


--
-- Name: tickets trg_notify_ticket_status_change; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_notify_ticket_status_change AFTER UPDATE ON public.tickets FOR EACH ROW EXECUTE FUNCTION public.notify_ticket_status_change();


--
-- Name: tickets trg_ticket_code; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_ticket_code BEFORE INSERT ON public.tickets FOR EACH ROW EXECUTE FUNCTION public.generate_ticket_code();
...
--
-- Name: ticket_tracking ticket_tracking_changed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ticket_tracking
    ADD CONSTRAINT ticket_tracking_changed_by_fkey FOREIGN KEY (changed_by) REFERENCES public.profiles(id);


--
-- Name: ticket_tracking ticket_tracking_ticket_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ticket_tracking
    ADD CONSTRAINT ticket_tracking_ticket_id_fkey FOREIGN KEY (ticket_id) REFERENCES public.tickets(id) ON DELETE CASCADE;
...
--
-- Name: profiles Admin can read all profiles; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: profiles Allow insert own profile; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: profiles Allow read own profile; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Allow read own profile" ON public.profiles FOR SELECT USING ((auth.uid() = id));


--
-- Name: profiles Allow update own profile; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: ticket_attachments Users can insert own ticket attachments; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can insert own ticket attachments" ON public.ticket_attachments FOR INSERT WITH CHECK (((uploaded_by = auth.uid()) AND (EXISTS ( SELECT 1
   FROM public.tickets
  WHERE ((tickets.id = ticket_attachments.ticket_id) AND (tickets.user_id = auth.uid()))))));


--
-- Name: ticket_attachments Users can view own ticket attachments; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: tickets admin bisa hapus tiket; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "admin bisa hapus tiket" ON public.tickets FOR DELETE USING ((EXISTS ( SELECT 1
   FROM public.profiles
...
--
-- Name: comments insert comments; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: comments read comments; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: notifications read own notification; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "read own notification" ON public.notifications FOR SELECT USING ((auth.uid() = user_id));
...
--
-- Name: ticket_tracking read ticket tracking; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "read ticket tracking" ON public.ticket_tracking FOR SELECT USING (((EXISTS ( SELECT 1
   FROM public.profiles
  WHERE ((profiles.id = auth.uid()) AND (profiles.role = ANY (ARRAY['admin'::text, 'helpdesk'::text]))))) OR (EXISTS ( SELECT 1
   FROM public.tickets
  WHERE ((tickets.id = ticket_tracking.ticket_id) AND (tickets.user_id = auth.uid()))))));


--
-- Name: ticket_attachments staff bisa lihat lampiran tiket manapun; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "staff bisa lihat lampiran tiket manapun" ON public.ticket_attachments FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.profiles
  WHERE ((profiles.id = auth.uid()) AND (profiles.role = ANY (ARRAY['admin'::text, 'helpdesk'::text]))))));


--
-- Name: ticket_tracking staff insert ticket tracking; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "staff insert ticket tracking" ON public.ticket_tracking FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM public.profiles
  WHERE ((profiles.id = auth.uid()) AND (profiles.role = ANY (ARRAY['admin'::text, 'helpdesk'::text]))))));


--
-- Name: tickets staff read all tickets; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "staff read all tickets" ON public.tickets FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND (p.role = ANY (ARRAY['helpdesk'::text, 'admin'::text]))))));


--
-- Name: tickets staff update tickets; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "staff update tickets" ON public.tickets FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND (p.role = ANY (ARRAY['helpdesk'::text, 'admin'::text]))))));
...
--
-- Name: ticket_tracking; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: notifications update own notification; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: notifications user bisa lihat notifikasi sendiri; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "user bisa lihat notifikasi sendiri" ON public.notifications FOR SELECT USING ((auth.uid() = user_id));


--
-- Name: profiles user bisa lihat profile staff yang menangani tiketnya; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "user bisa lihat profile staff yang menangani tiketnya" ON public.profiles FOR SELECT USING ((role = ANY (ARRAY['admin'::text, 'helpdesk'::text])));


--
-- Name: notifications user bisa update is_read notifikasi sendiri; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "user bisa update is_read notifikasi sendiri" ON public.notifications FOR UPDATE USING ((auth.uid() = user_id));


--
-- Name: tickets user create ticket; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "user create ticket" ON public.tickets FOR INSERT WITH CHECK ((auth.uid() = user_id));


--
-- Name: tickets user read own tickets; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "user read own tickets" ON public.tickets FOR SELECT USING ((auth.uid() = user_id));
...
CREATE POLICY "Authenticated users can upload ticket attachments" ON storage.objects FOR INSERT WITH CHECK (((bucket_id = 'ticket-attachments'::text) AND (auth.role() = 'authenticated'::text)));
...
--
-- Name: FUNCTION notify_admins_new_ticket(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.notify_admins_new_ticket() TO anon;
GRANT ALL ON FUNCTION public.notify_admins_new_ticket() TO authenticated;
GRANT ALL ON FUNCTION public.notify_admins_new_ticket() TO service_role;


--
-- Name: FUNCTION notify_admins_status_change_by_helpdesk(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.notify_admins_status_change_by_helpdesk() TO anon;
GRANT ALL ON FUNCTION public.notify_admins_status_change_by_helpdesk() TO authenticated;
GRANT ALL ON FUNCTION public.notify_admins_status_change_by_helpdesk() TO service_role;


--
-- Name: FUNCTION notify_helpdesk_assigned(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.notify_helpdesk_assigned() TO anon;
GRANT ALL ON FUNCTION public.notify_helpdesk_assigned() TO authenticated;
GRANT ALL ON FUNCTION public.notify_helpdesk_assigned() TO service_role;


--
-- Name: FUNCTION notify_ticket_status_change(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.notify_ticket_status_change() TO anon;
GRANT ALL ON FUNCTION public.notify_ticket_status_change() TO authenticated;
GRANT ALL ON FUNCTION public.notify_ticket_status_change() TO service_role;
...
--
-- Name: TABLE ticket_tracking; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.ticket_tracking TO anon;
GRANT ALL ON TABLE public.ticket_tracking TO authenticated;
GRANT ALL ON TABLE public.ticket_tracking TO service_role;


--
-- Name: SEQUENCE ticket_tracking_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public.ticket_tracking_id_seq TO anon;
GRANT ALL ON SEQUENCE public.ticket_tracking_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.ticket_tracking_id_seq TO service_role;
...
\unrestrict Gam9YHgh8NVgNjfq0zqFxqVGvz4Mfa6dh38x4rhHYL0acevftZ9baXkq1qcXabp
