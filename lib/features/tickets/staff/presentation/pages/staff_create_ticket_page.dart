...
class StaffCreateTicketPage extends StatefulWidget {
  ...
  const StaffCreateTicketPage({super.key, required this.role});
            ...
            children: [
              Expanded(
                child: OutlinedButton.icon(
                  onPressed: provider.isLoading
                      ? null
                      : () => context.read<StaffTicketProvider>().pickFromCamera(),
              ...
              Expanded(
                child: OutlinedButton.icon(
                  onPressed: provider.isLoading
                      ? null
                      : () => context.read<StaffTicketProvider>().pickFromGallery(),
